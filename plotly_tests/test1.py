...
iris = pd.read_csv(r'D:\PyCharm\Indras_Pearls\iris.data', names=['s_length', 's_width', 'p_length', 'p_width', 'species'])
# fig = px.scatter(iris, x='s_width', y='s_length', symbol='species', color='p_length', size='p_width')
s = 6
